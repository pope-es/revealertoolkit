...
Output is sent to \texttt{output/parser}. Each output file or folder has a prefix indicating the filetype it came from (PST, PDF...) and a numerical suffix.

For each file or folder, you will also have another one with `RVT\_metadata' appended to its name. This special file indicates the source file the data came from. Example:
\begin{verbatim}
Source file: /media/morgue/100103-w2k/(...)/GuestSDK_Terms_and_Conditions.pdf
Parsed by RVT module RVT_parse version 1.0
\end{verbatim}
